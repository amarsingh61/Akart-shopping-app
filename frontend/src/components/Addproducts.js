...
const Addproducts = ({setopenaddproducts,getallproducts}) => {
    ...
    <div className='flex items-center justify-center top-0 left-0 bottom-0 right-0 bg-black fixed bg-opacity-60 z-50'>
        <div className='bg-white p-5 rounded w-1/2 overflow-hidden h-[75vh]'>
            <div className='flex justify-between items-baseline'>
                ...
                <div className=' ml-auto text-2xl hover:cursor-pointer' onClick={()=>setopenaddproducts(false)}>
                    <IoMdClose/>
                </div> 
            </div>
            <form className='grid px-2 gap-3 overflow-y-scroll pb-3 h-[65vh]' onSubmit={submithandler}>
                ...
                <button className=' bg-red-700 text-white py-2 px-5 rounded-md hover:bg-red-900 cursor-pointer'>Upload Product</button>
